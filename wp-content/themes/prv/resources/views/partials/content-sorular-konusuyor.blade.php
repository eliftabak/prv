      ...
      <div class="turn-page col-12">
        <div class="page2">
          ...
          <div class="page2__background-emoji-container">
            <img src="{{$home}}wp-content/themes/prv/resources/assets/images/mavisayfalar-white-dots.png"
              alt="white-dots" class="page2__emoji page2__white-dots">
