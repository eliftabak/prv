...
<section class="container container__page-content pt-5">
  <div class="row">
    <div class="col-12">
      <div class="page1">
        <div class="row title-texts-container">
          <div class="col-6">
            <div class="box">
          ...
          <div class="col-4">
            <img src="{{$home}}wp-content/themes/prv/resources/assets/images/sorular-konusuyor.png"
              alt="sorular konusuyor" class="sorular-image">
          </div>
        </div>
      </div>
      <!----End of first page----->
    ...
    <div class="col-12">
      <div class="page2">
        ...
        <div class="page2__your-class">
          ...
          <div>
            <div class="page2__round-container">
              <p class="page2__round-container-lines">Araştırma sonuçlarımıza göre öğrenim sürecinde YENİ NESİL
                SORULARLA
          ...
          <div>
            <div class="page2__square-container">
              <p class="page2__square-container-lines">Bu sebeple uyguladığımız sistemi 5. sınıftan itibaren aynı
                formatta
        ...
        <div class="page2__background-emoji-container">
          ...
          <img src="{{$home}}wp-content/themes/prv/resources/assets/images/mavisayfalar-emoji4.png" alt="4"
