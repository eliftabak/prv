  ...
  <div class="row">
    <div class="col-12 mx-auto">
      <div class="error__wrapper text-center">
        <img class="error__image" src="{{home_url('/')}}wp-content/themes/prv/resources/assets/images/404.png" alt="">
        <h1 class="error__title">Aradığınız sayfa bulunamadı</h1>
        <a id="" class="btn btn-primary p-3 pl-5 pr-5 mt-3 rounded-pill" href="{{home_url('/')}}" target=""
