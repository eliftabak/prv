...
add_action("edit_user_profile_update", function ($user_id) {
    ...
    $akilli_tahta_page_url = get_permalink(get_page_by_path('akilli-tahta-uygulamalari'));
...
//TODO:Make redirect work after login;

$redirect_url = home_url("/iletisim/");

add_action('template_redirect', function () {

    global $redirect_url;

    if (is_page('hesabim') && isset($_GET['redirect_url'])) {
