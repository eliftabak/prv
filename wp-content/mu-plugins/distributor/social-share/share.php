...
?>
    <div class="prv-social-share">
      ...
      <ul>
        ...
        <li class="prv-social-share__item prv-social-share__whatsapp"><a href="whatsapp://send?text=<?php echo urlencode(esc_url($product_url)); ?>" target="_blank" rel="noopener noreferrer" data-action="share/whatsapp/share"><i class="fa fa-whatsapp" aria-hidden="true"></i></a></li>
      </ul>
    </div>
<?php
  }
