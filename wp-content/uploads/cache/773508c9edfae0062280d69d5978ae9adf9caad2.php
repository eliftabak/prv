          ...
          <div class="slider__wrapper carousel-inner">
            <div class="slider__item carousel-item active">
              <img class="d-block w-100"
                src="<?php echo e(home_url('/')); ?>wp-content/themes/prv/resources/assets/images/benimsorum.net-slayt-1.jpg">
            ...
            <div class="slider__item carousel-item">
              <img class="d-block w-100"
                src="<?php echo e(home_url('/')); ?>wp-content/themes/prv/resources/assets/images/benimsorum.net-slayt-2.jpg">
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="slider__item carousel-item">
              <img class="d-block w-100"
                src="<?php echo e(home_url('/')); ?>wp-content/themes/prv/resources/assets/images/benimsorum.net-slayt-3.jpg">
              <div class="carousel-caption d-none d-md-block">
